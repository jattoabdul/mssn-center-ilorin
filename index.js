...
const PROJECT_NAME = "MSS Centre Ilorin";
...
const NuxtConfig = {
  ...
  buildDir: 'dist',
  head: {
    title: 'MSS Centre Ilorin' || process.env.npm_package_name,
    htmlAttrs: {
      lang: 'en'
    },
    meta: [
      ...
      { hid: 'og:site_name', name: 'og:site_name', content: 'MSS Centre Ilorin' },
      { hid: 'apple-mobile-web-app-title', name: 'apple-mobile-web-app-title', content: 'MSSCI' },
      { hid: 'og:title', name: 'og:title', content: 'MSS Centre Ilorin' },
