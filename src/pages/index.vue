<template>
  <div class="page home">
    <header class="pb-0 lg:pb-10">
      <nav-bar />
      <div class="banner flex lg:flex-row flex-col justify-between lg:pt-32 pt-20">
        <div class="quote px-16 lg:pl-3 lg:pr-32">
          <p class="text arabic">وَٱعْتَصِمُواْ بِحَبْلِ ٱللَّهِ جَمِيعًا وَلَا تَفَرَّقُواْ</p>
          <p class="sub-text">
        ...
        <div class="prayer-time">
          ...
          <div v-else class="solats">
            ...
            <p class="heading">
              ...
              {{ solatSchedule && solatSchedule.date_for ? formatDate(`${solatSchedule.date_for.split('-')[1]}/${solatSchedule.date_for.split('-')[2]}/${solatSchedule.date_for.split('-')[0]}`, 'dd MMMM yyyy') : '' }}
            </p>
            <p class="timing">
              <span>Fajr</span>
    ...
    <section id="welcome" class="welcome">
      ...
      <p>
        ...
        Muhammad (PBUH). The centre will serve as a viable Islamic institution and
      ...
      <nuxt-link v-ripple to="/about" class="focus:outline-none" tag="button">Read More</nuxt-link>
    </section>
    <section class="philosophy">
      <h1 class="heading main">Our Philosophy</h1>
      <div class="points grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 col-gap-10 row-gap-12">
        <div class="point">
        ...
        <div class="point">
          ...
          <p>
            ...
            purpose of life.
            <br />Inevitably we must realise our relationship with Allah سبحانه وتعالى
        ...
        <div class="point">
          ...
          <p>
            ...
            اللَّهِ جَمِيعًا وَلَا تَفَرَّقُو
            <br />Hold fast to the rope of
            Allah, the faith of Islam, and be not divided in groups.
            <br />The expression &#39;rope of Allah&#39;, in this verse, refers to the
    ...
    <section class="services">
      ...
      >
        ...
        <div class="service">
          ...
          <p class="title" style="color: rgb(24, 54, 81)">Lodging/Hall Rentals</p>
          <p>
        ...
        <div class="service">
          ...
          <p class="title" style="color: rgb(38, 40, 44);">Zakat/Sadaqah</p>
          <p>
    ...
    <section class="school">
      ...
      <div class="text-white">
        <h1 class="heading">Madrasah (Islamic School)</h1>
        <p
      ...
      >
        ...
        <div v-else class="post hottest">
          ...
          <div class="py-2 px-4">
            ...
            <p class="title">{{ recentPosts[0].title }}</p>
        ...
        <div v-else class="recent">
          <nuxt-link
            ...
            class="post"
          >
            <p class="title">{{ recentPost.title }}</p>
            <p class="date-time">
...
export default {
  ...
  async asyncData() {
    const { data: recentData } = await graphql(GET_RECENT_POSTS, {
      orderCondition: "posted_DESC",
      num: 5
    });
    return {
  ...
  methods: {
    ...
    async getRecentPosts() {
      const { data } = await graphql(GET_RECENT_POSTS, {
        orderCondition: "posted_DESC",
        num: 5
      });
...
.home {
  ...
  .banner {
    ...
    .text {
      ...
      &.arabic {
        font-family: "Amiri", "Source Sans Pro", -apple-system,
